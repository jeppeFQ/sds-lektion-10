...
3. **Cosine distance**: måler vinklen mellem deres vektorer. To dokumenter der har præcis samme ordfordeling vil have en vinkel på $0$ grader mellem sig (cosine distance $= 0$), selv hvis det ene dokument er meget længere end det andet. 
